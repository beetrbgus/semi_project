...
<body>
		...
		<header class="app-header ">
			<div class="app-header-container">
				...
				<ul class="app-header-nav">
					...
					<li><a
						href="<%=request.getContextPath()%>/page/record/my_record.jsp"
					> <span>내 기록</span> <ion-icon class="tw-ml-1 tw-color-gray-600"
				...
				<div class="app-pc-only app-dropdown onlyLogin">
					...
					> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                       ...
                       <path
							...
							></path>
                     </svg> <%-- 알림 있을 때 갯수 뽑아줌. --%> <span
							class="app-header-item-badge"
						><%=newMessage%></span> <span id="msgCount"
							class="app-header-item-badge"
						><%=newMessage%></span>
					</a>
					<!-- 쪽지 목록 창. -->
 ...
 %> <img
						src="<%=root%>/resources/image/profile-user.png"
					> <%
 } else {
 %> <img
						src="<%=root%>/profile.kh?mpNo=<%=memberProfileDto.getMpNo()%>"
					> <%
 }
 %>
						...
						<div>
							...
							<ul class="app-dropdown-menu-list tw-py-2 app-custom-scroll">
								...
								> <ion-icon name="lock-open-outline" role="img"
											class="md hydrated" aria-label="lock open outline"
										></ion-icon> <span>로그아웃</span>
								</a></li>
							</ul>
						</div>
					</div>
