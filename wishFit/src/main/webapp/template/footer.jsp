<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!--  Footer 영역 . Main에 포함되어있음. -->
				<!--#Meta:layouts/slow/components/footer/footer.scss?$__Context->themeConfig->variables-->
				<div class="app-footer">
					<ul>
						<li><a href="terms.html">이용약관</a></li>
						<li><a href="privacy.html">개인정보처리방침</a></li>
						<li><a href="limit.html">책임의한계와 법적고지</a></li>
						
					</ul>
					<div class="app-footer-copy">ⓒ 2021 SWEATEE</div>
				</div>
			
		

		<!--  모바일 ui가 필요없다면 삭제해도 무방할거같아요  -->
				
					<!-- 화면 모바일로 줄면 나오는 하단 Nav 버튼 -->		
		<div class="app-layout-bottom-nav">
			<div class="app-bottom-nav" data-logged-in=""
				data-current-menu="home">
				<ul>
					<li data-menu-id="home">
						<a class="app-bottom-nav__auto app-active"> 
							<!--  홈 아이콘  -->
					...
					<li data-menu-id="notification">
						<a class="app-bottom-nav__auto">
							...
							<span class="app-bottom-nav-item__text">알림</span>
						</a>
					</li>
					<li data-menu-id="message">
						<a class="app-bottom-nav__auto">
							<div class="app-bottom-nav-item">
								<!--  쪽지 아이콘  -->
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
							...
							<span class="app-bottom-nav-item__text">쪽지</span>
						</a>
					</li>
				...
				<div class="tw-p-6">
						...
						<fieldset>
							<div class="tw-mb-3">
								<div class="app-labeled-input" label="이메일 주소">
									...
									<input id="email" class="app-input app-input-expand"
										type="text" name="user_id" placeholder="user@email.com"
										required tabindex="1"
									/>
								</div>
							</div>
					...
					<div class="app-social-login-group">
						...
						> <img src="layouts/slow/assets/images/ic_brand_kakao.svg"
							alt="ic_brand_kakao.svg" width="14" height="14"
						> <span>카카오로 계속하기</span>
						...
						> <img src="layouts/slow/assets/images/ic_brand_naver.svg"
							alt="ic_brand_naver.svg" width="14" height="14"
						> <span>네이버로 계속하기</span>
						</a>
					</div>
				</div>
	...
	<script async
		src="https://www.googletagmanager.com/gtag/js?id=G-CBF0R92LFH"
	></script>
	<script>
...
.pswp__caption__center {
	...
	<div id="rhymix_waiting" class="wfsr"
		data-message="서버에 요청 중입니다. 잠시만 기다려 주십시오..."
	></div>
	<!-- 알럿창. -->
	...
	<script src="addons/autolink/autolinkaeca.js?20210415215945"></script>
	<script
		src="addons/photoswipe/PhotoSwipe/photoswipea68c.js?20210415215946"
	></script>
	<script
		src="addons/photoswipe/PhotoSwipe/photoswipe-ui-defaulta68c.js?20210415215946"
	></script>
	<script src="addons/photoswipe/rx_photoswipeaeca.js?20210415215945"></script>
	<script
		src="layouts/slow/components/common/dialog/dialogeb30.js?20210328005045"
	></script>
	<script
		src="layouts/slow/components/common/labeled-input/labeled-inputeb30.js?20210328005045"
	></script>
	<script
		src="layouts/slow/components/common/select/selecteb30.js?20210328005045"
	></script>
	<script
		src="layouts/slow/components/common/toast/toasteb30.js?20210328005045"
	></script>
	<script
		src="layouts/slow/assets/js/jquery.cookiea57e.js?20210328005042"
	></script>
	<script
		src="layouts/slow/components/header/header-menu/header-menueb30.js?20210328005045"
	></script>
	<script
		src="layouts/slow/plugins/swiper/swiper.min7d9a.js?20210328005043"
	></script>
</body>

<!-- Mirrored from sweatee.co.kr/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Nov 2021 11:13:02 GMT -->