            ...
            <div class="app-card app-board-section">
               <div class="app-board-article-head">
                  <div class="app-board-container">
                     ...
                     <h1 class="tw-font-bold tw-text-3xl md:tw-text-xl">황 규 현 바보</h1>
               ...
               <div class="app-board-container app-article-container">
                  ...
                  <div class="app-article-content app-clearfix">
                     ...
                     <div class="document_512_431 rhymix_content xe_content">
                        <p>
                           <img
                              src="../files/attach/images/2021/04/06/38a67131df2cb66dda366a981882549d.jpg"
                              alt="DE53E17D-A314-4A9F-A7D0-03B276F88B39.jpeg.jpg" style="" />
                        </p>
                        <p>
                           <br />
                        </p>
                        <p>코로나 특수로 자전거 업계가 활황이라더니</p>
                        <p>아소스 태릉점이 곧 오픈 예정이네요. </p>
                     </div>
                     ...
                     <div class="tw-flex tw-pt-8">
                        <div class="tw-pr-6">
                           <ul class="app-article-tags">
                              <li><a
                                 href="../bike15c3.html?search_target=tag&amp;search_keyword=%EC%95%84%EC%86%8C%EC%8A%A4"
                                 class="tag" rel="tag">아소스</a></li>
                           </ul>
                        </div>
                        <div class="tw-flex-1"></div>
                  ...
                  <div class="app-article-footer">
                     ...
                     <div class="app-article-vote" data-target-srl="512">
                        <button class="app-article-vote__up" data-type="up"
                           onclick="appArticleVote(this)">
