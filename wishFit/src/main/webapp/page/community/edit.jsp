      ...
      <div id="app-board" class="app-board-skin ">
         <div class="app-write-form__back-wrap">
            <a class="app-write-form__back" href="/coordiboard"> <ion-icon
                  ...
                  aria-label="arrow back sharp"></ion-icon> <span>게시글 수정</span>
            </a>
         </div>
         <div class="app-card">
            <div class="app-board-section app-board-section-padding">
               <form action="edit.kh" method="post" 
                  ...
                  class="ed write-form inner-container" enctype="multipart/form-data">
                  <!-- 히든으로 작성자 아이디 (세션) 보내기 -->
                  <input type="hidden" name="boardWriter" value="<%=boardImageVO.getBoardWriter()%>">
                  ...
                  <div class="tw-flex tw-items-center sm:tw-block tw-mb-6">
                     ...
                     <!-- 중분류 -->
                     	<input type="hidden" name="boardLargeName" value="커뮤니티">
                        <select name="boardMiddleName" >
                        
                           <%if(boardImageVO.getBoardMiddleName().equals("전체")){ %>
                           ...
                           <option>운동인증</option>
                           <option>추천글</option>
                           <%}else if(boardImageVO.getBoardMiddleName().equals("유머")){ %>
                           <option>전체</option>
                           ...
                           <option>운동인증</option>
                           <option>추천글</option>
                           <%} else if(boardImageVO.getBoardMiddleName().equals("질문")){%>
                           <option>전체</option>
                           <option>유머</option>
                           ...
                           <option>운동인증</option>
                           <option>추천글</option>
                           <%} else if(boardImageVO.getBoardMiddleName().equals("운동코디")){%>
                           <option>전체</option>
                           <option>유머</option>
                           <option>질문</option>
                           <option selected>운동코디</option>
                           <option>운동인증</option>
                           <option>추천글</option>
                          <%} else if(boardImageVO.getBoardMiddleName().equals("운동인증")){%>
                           <option>전체</option>
                           <option>유머</option>
                           <option>질문</option>
                           <option>운동코디</option>
                           <option selected>운동인증</option>
                           <option>추천글</option>
                           <%} else if(boardImageVO.getBoardMiddleName().equals("추천글")){%>
                           <option>전체</option>
                           <option>유머</option>
                           <option>질문</option>
                           <option>운동코디</option>
                           <option>운동인증</option>
                           <option selected>추천글</option>
                           <%} %>
                        </select>
         ...
         <%} %>
                  ...
                  <div>
                     ...
                     <div class="sm:tw-block tw-flex tw-items-center">
                        ...
                        <div class="tw-flex">
                           <%-- 취소버튼 --%>
                            <a href="<%=root %>/page/community/list.jsp?boardLargeName=커뮤니티" class="app-button tw-mr-2 sm:tw-flex-1">취소</a>
                           <%-- 수정버튼 --%>
