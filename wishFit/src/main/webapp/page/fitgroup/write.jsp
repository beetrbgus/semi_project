   ...
   <div class="app-clearfix">
      ...
      <div id="app-board" class="app-board-skin ">
         <div class="app-card">
           ...
           <form action="write.kh" method="post" enctype="multipart/form-data" id="fgwrite">
                  ...
                  <div class="app-board-editor-wrap tw-mb-3">
                     ...
                     <div id="ckeditor_instance_1" data-editor-sequence="1"
                        ...
                        <div id="cke_editor1"
                           ...
                           <textarea name="fgIntro" required class="form-input fgMemo" rows="10" >  
                            </textarea>
                             <script>
        $(function(){
				...
				$(function(){
					...
					<input id="end" type="hidden" name="fgEndtime" required></td>
                     ...
                     <div id="xefu-container-1" class="xefu-container xe-clearfix"
                  	...
                  	<label>운동 위치 :</label>
                    <input type="text" name="fgLocation" required>
					<input type="hidden" name="fgLatitude">
					<input type="hidden" name="fgLongitude">
					<br>
					<input type="file" name="fgImage">
<!--                    <input id="xe-fileupload" type="file" name="fgImage   -->
<!--                          class="fileupload-processing" data-auto-upload="true" data-editor-sequence="1" multiple=""> -->
               		 </div>     
