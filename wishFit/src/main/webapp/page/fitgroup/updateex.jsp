	...
	<form action="update.kh" method="post"  id="fgwrite">
		...
		<table>
			<tbody>
				...
				<td><input type="hidden" name="fgNo" value="<%=fitgroupDto.getFgNo()%>"></td>
				</tr>
				<tr>
				<tr>
					<th>카테고리</th>
				...
				<tr>
					<th>제목</th>
					<td><input type="text" name="fgTitle"  value="<%=fitgroupDto.getFgTitle()%>" required></td>
				</tr>
				 <script>
        $(function(){
            $("#fgMemo").on("input", function(){
				...
				<tr>
					<th>소개</th>
					<td>
					<textarea id="fgMemo" name="fgIntro" value="<%=fitgroupDto.getFgIntro()%>" required rows="10">
					</textarea>
				...
				<tr>
					<th>위치</th>
					<td><input type="text" name="fgLocation" value="<%=fitgroupDto.getFgLocation()%>" required></td>
					<td><input type="text" name="fgLatitude" value="<%=fitgroupDto.getFgLatitude() %>"></td>
					<td><input type="text" name="fgLongitude" value="<%=fitgroupDto.getFgLongtitude() %>"></td>
				</tr>
				<tr>
					<td>이미지 사진</td>
				...
				<tr>
					<th>시작시간</th>
					<td><input id="startDate" type="date" > <input
						id="startTime" type="time" > <input id="start"
						type="text" name="fgStarttime" value="<%=fitgroupDto.getFgStarttime()%>"></td>

				</tr>
				<tr>
					<th>종료시간</th>
					<td><input id="endDate" type="date" > <input
						id="endTime" type="time" > <input id="end"
						type="text" name="fgEndtime" value="<%=fitgroupDto.getFgEndtime()%>"></td>
				...
				<tr>
					<td colsapn="2">
						...
						<button id="fgBtn" type="submit">글 수정하기</button>
