...
boolean admin = grade != null && (grade.equals("총관리자") || grade.equals("마켓관리자"));
%>
<%
//상세 페이지 불러오기
			...
			<div class="app-article-wrap" style="max-width:">
				<div class="app-card app-board-section">
					...
					<div class="app-article-toolbar">
						<div class="app-board-container">
							<a class="app-link" href="market_list.jsp?boardLargeName=마켓">
              ...
              <path fill-rule="evenodd"
							...
							<div class="tw-flex-1"></div>
							<%if (boardImageVO.getBoardWriter().equals(boardWriter) || admin) {%>
								<a class="app-link app-link tw-text-sm document_512" href="market_edit.jsp?boardNo=<%=boardImageVO.getBoardNo()%>">
								<span>수정</span></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
