...
%>
<%
String boardLargeName = "마켓";



 
BoardDao boardDao = new BoardDao();
List<BoardDto> list = boardDao.list(boardLargeName); //boardMiddleName
...
<%--  									 이미지사진 불러오기 실패 보류<img src="download.kh?imageNo=<%=imageDto.getImageNo()%>"> --%>
									</div>
									<div class="tw-flex-1">
  ...
  <ul class="app-pagination">
    <li class="app-pagination-first">
      ...
      <a href="/community?page=1">
        ...
        <a href="/community?page=1">1</a>
      </li>
          <li class="app-active">
        <a href="/community?page=2">2</a>
      </li>
          </ul>
</div>
...
<jsp:include page="/template/bottomNav.jsp"></jsp:include>2