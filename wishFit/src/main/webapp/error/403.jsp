...
<section class="xedition-error">
	<h1>403</h1>
	<p><a href="<%=request.getContextPath() %>/index.jsp">메인 화면으로 이동</a><br>로그인이 필요한 메뉴입니다.</p>
	
	<img src="<%=request.getContextPath() %>/resources/image/error.png" width="340" height="400">
</section>
