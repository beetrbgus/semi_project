...
public class FriendVo {
	...
	public void setFriendGrade(String friendGrade) {
		this.friendGrade = friendGrade;
	}
	public int getFriendProfile_No() {
		return friendProfile_No;
	}
	public void setFriendProfile_No(int friendProfile_No) {
		this.friendProfile_No = friendProfile_No;
	}
